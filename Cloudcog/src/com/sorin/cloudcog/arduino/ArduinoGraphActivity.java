 ...
 */
package com.sorin.cloudcog.arduino;
...
public class ArduinoGraphActivity extends Activity {
	...
	private ArduinoGraphView mGraphIOIO;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.arduino_graph);

		// get handles to Views defined in our layout file
		ArduinoGraphView mGraphIOIO = (ArduinoGraphView) findViewById(R.id.grapharduino);
		mValueTV = (TextView) findViewById(R.id.valuearduino);
	...
	protected void onStart() {
		super.onStart();
		Toast.makeText(this, "Arduino Sensor Data", Toast.LENGTH_SHORT).show();
