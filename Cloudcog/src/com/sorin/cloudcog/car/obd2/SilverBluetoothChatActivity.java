...
public class SilverBluetoothChatActivity<ImageView> extends FragmentActivity {
	// fragment management
	...
	public synchronized void onResume() {
		...
		if (mChatService != null) {
			...
			if (mChatService.getState() == BluetoothChatService.STATE_NONE) {
				...
				mChatService.start();
				// Add the following line to register the Session Manager
				// Listener
				// onResume
	...
	public void clearCodes() {
		...
		if (mConnectedDeviceName != null) {
			...
			Toast.makeText(getApplicationContext(),
					"OBD Adapter NOT CONNECTED", Toast.LENGTH_SHORT).show();
		}
	...
	/*
	 * private void ensureDiscoverable() { if(D) Log.d(TAG,
	 * "ensure discoverable"); if (mBluetoothAdapter.getScanMode() !=
			...
			case MESSAGE_READ:
				...
				if ((dataRecieved != null)
					...
					case 15:// PID(0F): Intake Temperature
						...
						if (prev_intake == 0) {
							RotateAnimation Intake_animation = new RotateAnimation(
									-105, needle_value, 30, 97);
							...
							RotateAnimation Intake_animation = new RotateAnimation(
									prev_intake, needle_value, 30, 97);
							prev_intake = needle_value;
							Intake_animation
									.setInterpolator(new LinearInterpolator());
							Intake_animation.setDuration(500);
					...
					case 4:// PID(04): Engine Load
						...
						if (prev_load == 0) {
							...
							RotateAnimation Load_animation = new RotateAnimation(
									-105, needle_value, 30, 97);
							Load_animation
									.setInterpolator(new LinearInterpolator());
					...
					case 5:// PID(05): Coolant Temperature
						...
						if (prev_coolant == 0) {
							RotateAnimation Coolant_animation = new RotateAnimation(
									-83, needle_value, 30, 97);
							Coolant_animation
									.setInterpolator(new LinearInterpolator());
							...
							RotateAnimation Coolant_animation = new RotateAnimation(
									prev_coolant, needle_value, 30, 97);
							Coolant_animation
									.setInterpolator(new LinearInterpolator());
							Coolant_animation.setDuration(500);
							Coolant_animation.setFillAfter(true);
					...
					case 12: // PID(0C): RPM
						...
						if (prev_RPM == 0) {
							RotateAnimation RPM_animation = new RotateAnimation(
									-85, needle_value, 30, 97);
							RPM_animation
									.setInterpolator(new LinearInterpolator());
					...
					case 13:// PID(0D): MPH
						...
						if (prev_MPH == 0) {
							RotateAnimation MPH_animation = new RotateAnimation(
									-85, needle_value, 30, 97);
							MPH_animation
									.setInterpolator(new LinearInterpolator());
					...
					if (PID == 12) {
						...
						case 15:// PID(0F): Intake Temperature
							...
							if (prev_intake == 0) {
								...
								Intake_animation.setFillAfter(true);
								((View) pointer4)
										.startAnimation(Intake_animation);
							} else {
								RotateAnimation Intake_animation = new RotateAnimation(
										prev_intake, needle_value, 30, 97);
								prev_intake = needle_value;
						...
						case 5:// PID(05): Coolant Temperature
							...
							if (prev_coolant == 0) {
								...
								Coolant_animation.setFillAfter(true);
								((View) pointer3)
										.startAnimation(Coolant_animation);
								prev_coolant = needle_value;
							} else {
								RotateAnimation Coolant_animation = new RotateAnimation(
										prev_coolant, needle_value, 30, 97);
					...
					if (prev_voltage == 0) {
						RotateAnimation Voltage_animation = new RotateAnimation(
								-100, volt_value, 30, 97);
						Voltage_animation
								.setInterpolator(new LinearInterpolator());
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.secure_connect_scan:
			 ...
			 * REQUEST_CONNECT_DEVICE_INSECURE); return true; case
		...
		case R.id.action_ruby_gauges:
			Intent rubyIntent = new Intent(this,
					RubyBluetoothChatActivity.class);
		...
		case R.id.action_cosm_pull:
			...
			Intent mainIntent = new Intent(SilverBluetoothChatActivity.this,
					Login.class);
			mainIntent.putExtra("flag", "true");
			SilverBluetoothChatActivity.this.startActivity(mainIntent);
