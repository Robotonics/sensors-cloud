...
import com.sorin.cloudcog.cosmpush.httpclient.HttpClient;
import com.sorin.cloudcog.cosmpush.httpclient.HttpMethod;
import com.sorin.cloudcog.cosmpush.httpclient.HttpRequest;
import com.sorin.cloudcog.cosmpush.httpclient.HttpResponse;
...
public class Cosm {
	 ...
	 */
	public Feed getFeed(int feed) throws CosmException {
	 ...
	 * @throws CosmException
	 */
	public boolean updateFeed(int feed, String s) throws CosmException {
		HttpRequest hr = new HttpRequest("http://api.cosm.com/v2/feeds/" + feed
				+ ".xml");
	 ...
	 * @throws CosmException
	 */
	public boolean createDatastream(int feed, String s) throws CosmException {
		HttpRequest hr = new HttpRequest("http://api.cosm.com/v2/feeds/" + feed
				+ "/datastreams/");
		hr.setMethod(HttpMethod.POST);
		hr.addHeaderItem("X-PachubeApiKey", this.API_KEY);
