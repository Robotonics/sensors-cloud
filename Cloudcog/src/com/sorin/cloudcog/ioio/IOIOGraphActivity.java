 ...
 */
package com.sorin.cloudcog.ioio;
 ...
 * 
 */
public class IOIOGraphActivity extends Activity {
	...
	private IOIOGraphView mGraphIOIO;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.ioio_graph);

		// get handles to Views defined in our layout file
		IOIOGraphView mGraphIOIO = (IOIOGraphView) findViewById(R.id.graphioio);
		mValueTV = (TextView) findViewById(R.id.valueioio);

		mGraphIOIO.setMaxValue(1024);
	...
	protected void onStart() {
		super.onStart();
		Toast.makeText(this, "IOIO Sensor Data", Toast.LENGTH_SHORT).show();
	...
	public class ArduinoReceiver extends BroadcastReceiver {
		...
		public void onReceive(Context context, Intent intent) {
			// Modified from null to AmarinoIntent.EXTRA_DATA_TYPE
			String data = AmarinoIntent.EXTRA_DATA_TYPE;
			...
			if (dataType == AmarinoIntent.STRING_EXTRA) {
				...
				if (data != null) {
					...
					try {
						...
						mGraphIOIO.addDataPoint(sensorReading);
