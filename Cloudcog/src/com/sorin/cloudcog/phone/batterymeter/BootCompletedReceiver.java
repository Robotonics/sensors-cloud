...
public class BootCompletedReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		SharedPreferences sp_store = context
				.getSharedPreferences("sp_store", 0);

		String startPref = settings.getString(SettingsActivity.KEY_AUTOSTART,
				"auto");

		 if (startPref.equals("always")
		 || (startPref.equals("auto") && sp_store.getBoolean(
