...
public class Predictor {
	...
	private static final String[] KEY_AVERAGE = { "key_ave_discharge",
			"key_ave_recharge_ac", "key_ave_recharge_wl",
	...
	public Predictor(Context context) {
		...
		pc = new PredictorCore(sp_store.getFloat(
				KEY_AVERAGE[PredictorCore.DISCHARGE], -1), sp_store.getFloat(
				KEY_AVERAGE[PredictorCore.RECHARGE_AC], -1), sp_store.getFloat(
				KEY_AVERAGE[PredictorCore.RECHARGE_WL], -1), sp_store.getFloat(
				KEY_AVERAGE[PredictorCore.RECHARGE_USB], -1));
	}
