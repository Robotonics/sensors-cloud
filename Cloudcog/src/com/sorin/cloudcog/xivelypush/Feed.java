...
public class Feed {
	 ...
	 * 
	 * @param p
	 *            Pachube object which is used to authenticate user when
	 *            updating this feed
	 */
	public Feed(Xively p) {
		super();
		this.p = p;
	 ...
	 */
	public void createDatastream(Data d) throws XivelyException {
		if (p != null) {
	 ...
	 * 
	 * @param id
	 *            id of the datastream to update
	 * @param value
	 *            new datastream to replace the previous datastream
	 */
	 ...
	 */
	/*
	 * public String getGraph(int id, int width, int height, Color c){ if(p !=
	 * null){ return this.p.showGraph(this.id, id, width, height, c); } return
	 * null; }
	 */
	 ...
	 * @throws XivelyException
	 */
	private void update() throws XivelyException {
		if (p != null) {
			if (this.Created) {
	 ...
	 * @throws XivelyException
	 */
	public void setTitle(String title) throws XivelyException {
		this.title = title;
		update();
	}
	 ...
	 * @throws XivelyException
	 */
	public void setStatus(Status status) throws XivelyException {
		this.status = status;
		update();
	}
	 ...
	 * @throws XivelyException
	 */
	public void setDescription(String description) throws XivelyException {
	 ...
	 * @throws XivelyException
	 */
	public void setWebsite(URL website) throws XivelyException {
	 ...
	 * @throws XivelyException
	 */
	public void setEmail(String email) throws XivelyException {
		this.email = email;
		update();
	}
	 ...
	 * @throws XivelyException
	 */
	public void setLocation(Location location) throws XivelyException {
